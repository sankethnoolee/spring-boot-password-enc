package encLogin.controller;


import encLogin.model.Login;
import encLogin.model.SuccessResponse;
import encLogin.utils.GenerateKeys;
 ...
 private GenerateKeys generateKeys ;
    ...
    public SuccessResponse key(@RequestParam(value = "appId", required = true) String appId) {
        ...
        if (null != appId && !appId.equals("")) {
            res.setData(generateKeys.getGeneratedPublicKey());
            return res;
